...
const ROTEIRO = [
  ...
  { t: 'type', text: 'Obrigado por tentar me incluir nas suas ideias de rolês e resenhas, mesmo sabendo que tenho uma alma de velho cansado e calvo 👴🏼' },
  { t: 'pause', ms: 900 },
  { t: 'backspace', count: 8 },
  { t: 'type', text: 'pouco sociável. Pelas paranóias 🫠' },
  { t: 'pause', ms: 900 },
  ...
  { t: 'type', text: 'cercam, que seus desejos e objetivos se realizem, e tudo conspire a seu favor para que você seja feliz da forma que almeja, muito além do que imagina merecer neste novo ciclo.'},  
  { t: 'newline' },
